                      ...
                      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                        <div className="flex items-start gap-4">
                          ...
                          <div>
                            ...
                            <p className={`text-xs mb-2 ${darkMode ? 'text-slate-400' : 'text-gray-500'}`}>{ch.description}</p>
                      ...
                      <div key={reward.id} className={`p-4 rounded-xl border transition-all ${darkMode ? 'bg-slate-700/50 border-slate-600' : 'bg-slate-50 border-slate-200'}`}>
                        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                          ...
                          <button
                            ...
                            className={`px-4 py-2 rounded-lg text-xs font-bold transition-all shadow-md shrink-0 whitespace-nowrap ${(reward.available && canAfford)
